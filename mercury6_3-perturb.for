...
c------------------------------------------------------------------------------
c
      subroutine mfo_user (time,jcen,rcen,nbod,nbig,m,x,v,a,s,rho)
c
      implicit none
      include 'mercury.inc'
c THIS IS THE COPY
...
c Local
      integer i, j
      real*8 radr, mnsd, extp(3), rinf, prfk, cvac, fgr1(3), fgr2(3) 
      real*8 fgr3(3), fgr(3), fT(3), fR(3), radv, objR, OmgCt
